 ...
 */
SHERPA_ONNX_API void
SherpaOnnxOnlineStreamAcceptWaveform(const SherpaOnnxOnlineStream *stream,
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxOnlineStreamSetOption(const SherpaOnnxOnlineStream *stream,
...
SherpaOnnxOnlineStreamGetOption(const SherpaOnnxOnlineStream *stream,
                                const char *key);
 ...
 * @endcode
 */
SHERPA_ONNX_API const SherpaOnnxDisplay *
SherpaOnnxCreateDisplay(int32_t max_word_per_line);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxAcceptWaveformOffline(const SherpaOnnxOfflineStream *stream,
                                int32_t sample_rate, const float *samples,
                                int32_t n);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxOfflineStreamSetOption(const SherpaOnnxOfflineStream *stream,
                                 const char *key, const char *value);
 ...
 */
SHERPA_ONNX_API const char *
SherpaOnnxOfflineStreamGetOption(const SherpaOnnxOfflineStream *stream,
                                 const char *key);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxDecodeOfflineStream(const SherpaOnnxOfflineRecognizer *recognizer,
                              const SherpaOnnxOfflineStream *stream);
 ...
 */
SHERPA_ONNX_API const char *
SherpaOnnxGetOfflineStreamResultAsJson(const SherpaOnnxOfflineStream *stream);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxDecodeKeywordStream(const SherpaOnnxKeywordSpotter *spotter,
                              const SherpaOnnxOnlineStream *stream);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxResetKeywordStream(const SherpaOnnxKeywordSpotter *spotter,
                             const SherpaOnnxOnlineStream *stream);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxDecodeMultipleKeywordStreams(const SherpaOnnxKeywordSpotter *spotter,
...
SherpaOnnxGetKeywordResult(const SherpaOnnxKeywordSpotter *spotter,
                           const SherpaOnnxOnlineStream *stream);
 ...
 */
SHERPA_ONNX_API const char *
SherpaOnnxGetKeywordResultAsJson(const SherpaOnnxKeywordSpotter *spotter,
                                 const SherpaOnnxOnlineStream *stream);
 ...
 * @endcode
 */
SHERPA_ONNX_API const SherpaOnnxCircularBuffer *
SherpaOnnxCreateCircularBuffer(int32_t capacity);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxDestroyCircularBuffer(const SherpaOnnxCircularBuffer *buffer);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxCircularBufferPush(const SherpaOnnxCircularBuffer *buffer,
...
SherpaOnnxCircularBufferGet(const SherpaOnnxCircularBuffer *buffer,
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxCircularBufferPop(const SherpaOnnxCircularBuffer *buffer, int32_t n);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxCircularBufferReset(const SherpaOnnxCircularBuffer *buffer);
...
SherpaOnnxCreateOfflineTts(const SherpaOnnxOfflineTtsConfig *config);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxDestroyOfflineTtsGeneratedAudio(const SherpaOnnxGeneratedAudio *p);
 ...
 *         SherpaOnnxFreeWave().
 */
SHERPA_ONNX_API const SherpaOnnxWave *
SherpaOnnxReadWaveFromBinaryData(const char *data, int32_t n);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxFreeMultiChannelWave(const SherpaOnnxMultiChannelWave *wave);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxSpeakerEmbeddingExtractorDestroyEmbedding(const float *v);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxSpeakerEmbeddingManagerFreeSearch(const char *name);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxSpeakerEmbeddingManagerFreeAllSpeakers(const char *const *names);
...
SherpaOnnxCreateAudioTagging(const SherpaOnnxAudioTaggingConfig *config);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxDestroyAudioTagging(const SherpaOnnxAudioTagging *tagger);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxAudioTaggingFreeResults(const SherpaOnnxAudioEvent *const *p);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxDestroyOfflinePunctuation(const SherpaOnnxOfflinePunctuation *punct);
 ...
 */
SHERPA_ONNX_API const char *
SherpaOfflinePunctuationAddPunct(const SherpaOnnxOfflinePunctuation *punct,
                                 const char *text);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxDestroyLinearResampler(const SherpaOnnxLinearResampler *p);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxLinearResamplerReset(const SherpaOnnxLinearResampler *p);
 ...
 */
SHERPA_ONNX_API const SherpaOnnxResampleOut *
SherpaOnnxLinearResamplerResample(const SherpaOnnxLinearResampler *p,
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxLinearResamplerResampleFree(const SherpaOnnxResampleOut *p);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxDestroyDenoisedAudio(const SherpaOnnxDenoisedAudio *p);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxDestroyOnlineSpeechDenoiser(const SherpaOnnxOnlineSpeechDenoiser *sd);
 ...
 */
SHERPA_ONNX_API void
SherpaOnnxOnlineSpeechDenoiserReset(const SherpaOnnxOnlineSpeechDenoiser *sd);
 ...
 */
SHERPA_ONNX_API const SherpaOnnxOfflineTts *
SherpaOnnxCreateOfflineTtsOHOS(const SherpaOnnxOfflineTtsConfig *config,
                               NativeResourceManager *mgr);
